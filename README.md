...
Playable five-year web demo, version 0.5. Acquire scripts, audition talent, run productions, market and release movies, create sequels, pursue awards, and manage cash and debt. Progress saves on your device.
...
Version 0.5 shows full dollar amounts, accepts dollars in salary/loan/repayment fields, uses low/mid/big-budget film labels, explains all-Shoestring tradeoffs, and shows nominations and wins on talent cards.
