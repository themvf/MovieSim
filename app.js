import * as COMM from './commissions.js?v=0.41.0';
import {nextHire, standardOffer, deadlineWindows, commissionEstimate} from './experience.js?v=0.41.0';
import * as REC from "./reception.js?v=0.41.0";
import * as LIFE from "./studio-life.js?v=0.41.0";
import {GENRE_SYMBOLS} from "./card-genres.js?v=0.41.0";
import * as CL from "./clients.js?v=0.41.0";
import * as CH from "./chemistry.js?v=0.41.0";
import * as SF from "./scifi.js?v=0.41.0";
import * as N from "./narrative.js?v=0.41.0";
import * as E from "./engine.js?v=0.41.0";
import { portrait, poster, studioArt, settingCardArt, escapeHtml as h } from "./art.js?v=0.41.0";
const BUILD = "0.10.0";
