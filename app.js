...
import * as N from "./narrative.js?v=0.31.0";
import * as E from "./engine.js?v=0.31.0";
import { portrait, poster, studioArt, escapeHtml as h } from "./art.js?v=0.31.0";
const BUILD = "0.10.0";
...
function slate() {
 ...
 ${peopleBoard()}${opportunityBoard()}<div class="slate-layout"><section><div class="section-title"><h2>Your productions <span>${s.movies.length}</span></h2><div class="segmented">${[
   ["active", "Active"],
   ["streaming", "Streaming"],
   ["catalog", "Catalog"],
   ["all", "All"],
...
function movieDetail(m) {
 ...
 ${m.stage==="packaging"?button(m.scifiCards?"Revise your cards":"Enter the writers’ room", m.scifiCards?"scifiEdit":"writersRoom", `data-id="${m.id}"`, "outline full"):""}
...
function handle(e) {
  ...
  switch (a) {
    ...
    case "scifiEdit": {const film=E.movie(s,id);open("scifi",{id,cards:structuredClone(film.scifiCards),title:film.title,scale:film.scale});break;}
    case "sfPick": {
