import * as N from "./narrative.js?v=0.29.0";
import * as E from "./engine.js?v=0.29.0";
import { portrait, poster, studioArt, escapeHtml as h } from "./art.js?v=0.29.0";
const BUILD = "0.10.0";
...
function movieDetail(m) {
 ...
 ${m.stage==="packaging"?button("Enter the writers’ room", "writersRoom", `data-id="${m.id}"`, "outline full"):""}
