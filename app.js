...
import * as N from "./narrative.js?v=0.30.0";
import * as E from "./engine.js?v=0.30.0";
import { portrait, poster, studioArt, escapeHtml as h } from "./art.js?v=0.30.0";
const BUILD = "0.10.0";
