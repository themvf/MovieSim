import * as E from "./engine.js?v=0.27.0";
import { portrait, poster, studioArt, escapeHtml as h } from "./art.js?v=0.27.0";
const BUILD = "0.10.0";
...
function handle(e) {
  ...
  const a = b.dataset.action,
    id = b.dataset.id;
  switch (a) {
    case "writersRoom":open("writersRoom",{id,draft:[...E.storyOutline(E.movie(s,id))]});break;
