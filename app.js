...
import * as N from "./narrative.js?v=0.34.0";
import * as E from "./engine.js?v=0.34.0";
import { portrait, poster, studioArt, escapeHtml as h } from "./art.js?v=0.34.0";
const BUILD = "0.10.0";
...
function slate() {
 ...
 ${pressTeaser()}${commissionBoard()}${peopleBoard()}${opportunityBoard()}<div class="slate-layout"><section><div class="section-title"><h2>Your productions <span>${s.movies.length}</span></h2><div class="segmented">${[
   ["active", "Active"],
   ["streaming", "Streaming"],
   ["catalog", "Catalog"],
   ["all", "All"],
