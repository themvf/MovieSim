import * as REC from "./reception.js?v=0.37.0";
import * as LIFE from "./studio-life.js?v=0.37.0";
import {GENRE_SYMBOLS} from "./card-genres.js?v=0.37.0";
import * as CL from "./clients.js?v=0.37.0";
import * as CH from "./chemistry.js?v=0.37.0";
import * as SF from "./scifi.js?v=0.37.0";
import * as N from "./narrative.js?v=0.37.0";
import * as E from "./engine.js?v=0.37.0";
import { portrait, poster, studioArt, escapeHtml as h } from "./art.js?v=0.37.0";
const BUILD = "0.10.0";
...
function movieDetail(m) {
 ...
 ${m.scifiCards?`<section class="sf-concept"><span class="eyebrow">YOUR MOVIE CARDS</span><p>${h(SF.selected(m.scifiCards,m.genre).map(c=>c.name).join(" · "))}</p><p>Creative focus: ${SF.demands(m.scifiCards,m.genre).slice(0,2).map(([k])=>h(SF.DIMENSIONS[k])).join(" and ")}.</p></section>`:""}
