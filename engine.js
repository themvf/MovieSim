...
import * as PRESS from "./press.js?v=0.40.0";
import * as CH from "./chemistry.js?v=0.40.0";
import * as C from "./commissions.js?v=0.40.0";
import * as D from "./delays.js?v=0.40.0";
...
import * as P from "./personality.js?v=0.40.0";
export const ensurePersonalities=P.ensure;
export const workingStyle=P.style;
import * as SF from "./scifi.js?v=0.40.0";
import { authoredSpecs, evaluate as evaluateNarrative, executionPenalty } from "./narrative.js?v=0.40.0";
...
function addMovie(s, sc, parent = null, developing = false) {
  ...
  if(m.scifiCards) Object.assign(m,SF.identity(m.scifiCards,m.genre));
